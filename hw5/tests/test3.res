...
br label %label_2
label_2:
%t1 = phi i1 [ %t2, %label_0 ], [ 0, %label_1 ]
...
br label %label_8
label_8:
%t5 = phi i1 [ %t6, %label_6 ], [ 0, %label_7 ]
br label %label_5
label_5:
%t3 = phi i1 [ 1, %label_3 ], [ %t5, %label_8 ]
br i1 %t3, label %label_9, label %label_10
label_9:
%t7 = getelementptr [5 x i8], [5 x i8]* @.str0, i32 0, i32 0
call void @print(i8* %t7)
br label %label_11
label_10:
%t9 = getelementptr [6 x i8], [6 x i8]* @.str1, i32 0, i32 0
