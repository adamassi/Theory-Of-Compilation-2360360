...
{
       0,    61,    61,    69,    72,    83,   101,   106,   113,   117,
     119,   126,   132,   141,   145,   152,   157,   165,   173,   178,
     179,   180,   181,   186,   191,   195,   196,   198,   199,   201,
     202,   209,   214,   218,   223,   227,   237,   246,   251,   252,
     253,   254,   255,   256,   257,   258,   262,   266,   274,   295
};
#endif
...
#line 84 "parser.y"
{ 
        auto id_node = std::dynamic_pointer_cast<ast::ID>(yyvsp[-6]);
        if (symbolTable.isFunctionDefined(id_node->value)) {
            ...
            symbolTable.addFunctions(*std::dynamic_pointer_cast<ast::FuncDecl>(yyval));
        }
}
